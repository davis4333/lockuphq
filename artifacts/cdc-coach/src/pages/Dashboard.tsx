...
import { Lock, AlertTriangle, ChevronRight, ClipboardList, Archive } from "lucide-react";
...
function makeImageIcon(src: string) {
  return function ImageIcon(_props: { className?: string }) {
    return (
      <img
        src={src}
        alt=""
...
const MODULES: Module[] = [
  ...
  { id: "housing-log-admin", title: "Housing Log Admin", description: "Browse finalized logs and download editable Excel copies.", icon: Archive, route: "/housing-log-admin" },
