...
const MODULES: Module[] = [
  ...
  { id: "dr-writer-6-1", title: "DR Writer — Charge 6-1", description: "Draft a disciplinary report narrative for disobeying an order (6-1).", icon: DrDescriptionIcon, route: "/dr-writer-6-1" },
