...
> **FORMAT NOTE (2026-07-01) — this copy is superseded, see `kb/charges/6-1/master.md`.**
>
> This file is a duplicate of `kb/charges/6-1/master.md` as it stood before the single-paragraph
> format fix. The "Locked Six-Paragraph Output Format" (Section 4) and the matching six-paragraph
> instructions in Sections 11, 12, and 14 are **deprecated** — checked against 62 real, accepted
> FDOC Charge 6-1 reports (Okeechobee CI, 2018-2023), every one of which was ONE continuous
> paragraph. `docs/lockuphq_dr_writer_master_prompt_corrected.md` is the source of truth for
> output format; `kb/charges/6-1/master.md` carries the up-to-date FORMAT NOTE and pointers.
> Read that file, not this one, for current format guidance.
...
## 4. Locked Six-Paragraph Output Format
...
The following is the target output quality for a GREEN status 6-1 report. This example uses sanitized facts.
